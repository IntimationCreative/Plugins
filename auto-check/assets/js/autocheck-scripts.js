jQuery(document).ready(function($) {
	$('.autocheck.custombtn.get_updates').on('click', function(e) {
		e.preventDefault();
	...
	$('.autocheck.custombtn.single_update').on('click', function(e) {
		e.preventDefault();
	...
	function auto_check(action, button, buttonTxt, additional = []) {
		...
		$('.loader-wrap').show();
		var request = $.post(autocheck.ajaxurl, data, function(response) {
